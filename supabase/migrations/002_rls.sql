...
-- Orders are created via the place_order RPC (SECURITY DEFINER), not direct INSERT
-- But allow direct insert for the RPC invocation path (guest checkout)
...
CREATE POLICY "order_items_insert_rpc"
  ON public.order_items FOR INSERT
  WITH CHECK (TRUE);

-- ============================================================
-- NOTIFICATION LOG
-- Only admins can read; RPC inserts
-- ============================================================
...
CREATE POLICY "notification_log_insert_rpc"
